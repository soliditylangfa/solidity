...
public:
	...
	static FunctionDefinition const* functionCallToDefinition(FunctionCall const& _funCall, ContractDefinition const* _contract = nullptr);
...
protected:
	...
	void createReturnedExpressions(FunctionCall const& _funCall, ContractDefinition const* _contract = nullptr);
